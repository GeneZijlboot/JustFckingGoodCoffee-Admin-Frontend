                ...
                <div class="col-md-12">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                                ...
                                <table class="w-100 table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="user in users">
                                            ...
                                            <td class="crud-icon">
                                                <svg class="icon" data-bs-toggle="tooltip" title="delete.api.key" v-on:click="dynamicCrudAction('D', user)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
                                            </td>
                                            <td class="crud-icon">
                                                <svg class="icon" data-bs-toggle="tooltip" title="update.api.key" v-on:click="dynamicCrudAction('U', user)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
                                            </td>
                        ...
                        <div class="tab-pane fade" id="nav-products" role="tabpanel" aria-labelledby="nav-product-tab">
                            <button type="button" class="btn btn-primary my-3" v-on:click="dynamicCrudAction('C', null, products[0].controller)">Create product</button>
                            <div class="d-flex gap-3 align-items-center">
                        ...
                        <div class="tab-pane fade" id="nav-product-variants" role="tabpanel" aria-labelledby="nav-productvariant-tab">
                            <button type="button" class="btn btn-primary my-3" v-on:click="dynamicCrudAction('C', null, productvariants[0].controller)">Create product variant</button>
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <table class="w-100 table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="productvariants in productvariants">
                                            ...
                                            <td class="crud-icon">
                                                 <svg class="icon" v-on:click="dynamicCrudAction('D', productvariants, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
                                            </td>
                                            <td class="crud-icon">
                                                <svg class="icon" v-on:click="dynamicCrudAction('U', productvariants, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
                                            </td>
                        ...
                        <div class="tab-pane fade" id="nav-roles" role="tabpanel" aria-labelledby="nav-role-tab">
                            <button type="button" class="btn btn-primary my-3" v-on:click="dynamicCrudAction('C', null, roles[0].controller)">Create role</button>
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <table class="w-100 table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="role in roles">
                                            ...
                                            <td>{{role.name}}</td>
                                            <td class="crud-icon">
                                                <svg class="icon" v-on:click="dynamicCrudAction('D', role, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
                                            </td>
                                            <td class="crud-icon">
                                               <svg class="icon" v-on:click="dynamicCrudAction('U', role, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
                                            </td>
                                            <td class="crud-icon" style="border-right: 1px solid lightgray;">
                                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#black"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
                                            </td>
                        ...
                        <div class="tab-pane fade" id="nav-api-keys" role="tabpanel" aria-labelledby="nav-apikey-tab">
                            <button type="button" class="btn btn-primary my-3" v-on:click="dynamicCrudAction('C', null, apikeys[0].controller)">Create api key</button>
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <table class="w-100 table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="apikey in apikeys">
                                            <td>{{apikey.id}}</td>
                                            <td>{{apikey.integration_id}}</td>
                                            <td>{{apikey.provider}}</td>
                                            <td>{{apikey.public_key}}</td>
                                            <td style="padding-right: 20px;">{{apikey.secret_key}}</td>
                                            <td class="crud-icon">
                                                <svg class="icon" v-on:click="dynamicCrudAction('D', apikey, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
                                            </td>
                                            <td class="crud-icon">
                                                <svg class="icon" v-on:click="dynamicCrudAction('U', apikey, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
                                            </td>
                                            <td class="crud-icon" style="border-right: 1px solid lightgray;">
                                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#black"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
                                            </td>
                        ...
                        <div class="tab-pane fade" id="nav-messages" role="tabpanel" aria-labelledby="nav-message-tab">
                            <button type="button" class="btn btn-primary my-3" v-on:click="dynamicCrudAction('C', null, messages[0].controller)">Create messages</button>
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <table class="w-100 table table-striped">
                                    ...
                                    <tbody>
                                       <tr v-for="message in messages">
                                            ...
                                            <td>{{message.name}}</td>
                                            <td>{{message.controller}}</td>
                                            <td>{{message.message}}</td>
                                            <td class="crud-icon">
                                                <svg class="icon" v-on:click="dynamicCrudAction('D', message, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg>
                                            </td>
                                            <td class="crud-icon">
                                                <svg class="icon" v-on:click="dynamicCrudAction('U', message, null)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="black"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
                                            </td>
                                            <td class="crud-icon" style="border-right: 1px solid lightgray;">
                                                <svg class="icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#black"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
                                            </td>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async dynamicCrudAction(action, data, controller) {
                if (action == 'C') { //create
                    //show the correct page for creating a table row
                    this.showPage = controller;

                    //hide the datbase component
                    this.showDatabase = false;
                } else if (action == 'U') { //update

                    //set data equal to updateValues
                    this.updateValues = data;

                    //show the correct page for creating a table row
                    this.showPage = data.controller;
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            if (async) {
                                ...
                                // //delete all translations that belong to this product
                                // const deleteProductTranslations = {
                                //     id: item.id
                                // }
                                // console.log

                                // //request to delete translations
                                // this.req('POST', '/message/deleteMessage/', deleteProductTranslations)

                                // //delete all product variants that belong to this product
                                ...
                                this.req('POST', '/' + data.controller + '/delete' + data.controller, data).then((res) => {
                                    if (res.status) {
                                        this.dynamiclyGetTable(data.controller); //reload users adter delete
                                        Swal.fire({
                                            title: 'Success!',
