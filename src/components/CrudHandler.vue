            ...
            <div class="d-flex justify-content-center mt-5">
                <div class="container">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="p-2 form-control" id="password" placeholder="Enter password" v-model="password" required :disabled="updateValues" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="password_confirm" class="form-label">Confirm password*</label>
                                        <input type="password" class="p-2 form-control" id="password_confirm" placeholder="Confirm password" v-model="password_confirm" required :disabled="updateValues" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="d-flex justify-content-end align-items-end gap-2 mt-3">
                        <button class="btn btn-primary" type="button" v-on:click="updateValues ? dynamiclyAdjustTableRow(modelValue, 'Update') : dynamiclyAdjustTableRow(modelValue, 'Create')">{{ updateValues ? 'Update User' : 'Create User' }}</button>
                    ...
                    <div class="row justify-content-end align-items-center mt-5">
                        <div class="col-md-5 d-flex flex-column justify-content-center">
                            ...
                            <div class="d-flex justify-content-end align-items-end gap-2 my-3">
                                <button class="btn btn-primary" type="button" v-on:click="updateValues ? dynamiclyAdjustTableRow(modelValue, 'Update') : dynamiclyAdjustTableRow(modelValue, 'Create')">{{ updateValues ? 'Update Product' : 'Create Product' }}</button>
        ...
        <div v-if="modelValue == 'ProductVariant'">
            <div class="row justify-content-center align-items-center mt-5">
                <div class="col-md-5 d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex justify-content-end align-items-end gap-2 mt-3">
                        <button class="btn btn-primary" type="button" v-on:click="updateValues ? dynamiclyAdjustTableRow(modelValue, 'Update') : dynamiclyAdjustTableRow(modelValue, 'Create')">{{ updateValues ? 'Update Product Variant' : 'Create Product Variant' }}</button>
                        <button class="btn btn-secondary" type="button" v-on:click="cancelCreateScreen()">Cancel</button>
                    </div>
                </div>
            </div>
        ...
        <div v-if="modelValue == 'Role'">
            <div class="row justify-content-center align-items-center mt-5">
                <div class="col-md-5 d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex justify-content-end align-items-end gap-2 mt-3">
                        <button class="btn btn-primary" type="button" v-on:click="updateValues ? dynamiclyAdjustTableRow(modelValue, 'Update') : dynamiclyAdjustTableRow(modelValue, 'Create')">{{ updateValues ? 'Update Role' : 'Create Role' }}</button>
                        <button class="btn btn-secondary" type="button" v-on:click="cancelCreateScreen()">Cancel</button>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center align-items-center mt-5">
                <div class="col-md-5 d-flex flex-column justify-content-center">
                    ...
                    <div class="row mb-4">
                     ...
                     <div class="d-flex justify-content-end align-items-end gap-2 mt-3">
                        <button class="btn btn-primary" type="button" v-on:click="updateValues ? dynamiclyAdjustTableRow(modelValue, 'Update') : dynamiclyAdjustTableRow(modelValue, 'Create')">{{ updateValues ? 'Update Api Key' : 'Create Api Key' }}</button>
                        <button class="btn btn-secondary" type="button" v-on:click="cancelCreateScreen()">Cancel</button>
                    </div>
                </div>
            </div>
        ...
        <div v-if="modelValue == 'Message'">
            <div class="row justify-content-center align-items-center mt-5">
                <div class="col-md-5 d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex justify-content-end align-items-end gap-2 mt-3">
                        <button class="btn btn-primary" type="button" v-on:click="updateValues ? dynamiclyAdjustTableRow(modelValue, 'Update') : dynamiclyAdjustTableRow(modelValue, 'Create')">{{ updateValues ? 'Update Message' : 'Create Message' }}</button>
                        <button class="btn btn-secondary" type="button" v-on:click="cancelCreateScreen()">Cancel</button>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            setUpdateFieldValues(controller, updateValue) {
                //define data first
                switch (controller) {
                    case 'User':
                        //define values for User
                        updateValue.first_name ? this.first_name = updateValue.first_name : this.first_name = '';
                        updateValue.last_name ? this.last_name = updateValue.last_name : this.last_name = '';
                        updateValue.email ? this.email = updateValue.email : this.email = '';
                        updateValue.phone_number ? this.phone_number = updateValue.phone_number : this.phone_number = '';
                        updateValue.city ? this.city = updateValue.city : this.city = '';
                        updateValue.zipcode ? this.zipcode = updateValue.zipcode : this.zipcode = '';
                        updateValue.street_name ? this.street_name = updateValue.street_name : this.street_name = '';
                        updateValue.house_number ? this.house_number = updateValue.house_number : this.house_number = '';
                        break;

                    case 'Product':
                        //define values for Product
                    ...
                    case 'Role':
                        //define values for Role
                        updateValue.name ? this.role_name = updateValue.name : this.role_name = '';
                        break;
                    ...
                    case 'Message':
                        //define values for Message
                        updateValue.name ? this.variable = updateValue.name : this.variable = '';
                        updateValue.message ? this.message = updateValue.message : this.message = '';

                        //setting the selected language option
                        if (this.updateValues && this.updateValues.language) {
            ...
            async dynamiclyAdjustTableRow(controller, action) {
                //define empty data
                let data = {};
